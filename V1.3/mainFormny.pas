...
begin
  ...
  // annars är det volym i inglasning
...
begin
  ...
  begin
    ...
    // Sparar Luftspaltens dimension för vald inglasning
  end
  else
  begin
...
begin
  ...
  // Döp om den temporära filen till rätt format
...
begin
  ...
  begin
    ...
    begin
      ...
      Construction.IntValue['Fönsterskikt'] := 1;
    ...
    begin
      ...
      Construction.IntValue['Fönsterskikt'] := 3;
      // holder[2] + (holder[2]-1) <-- Gasspalter
    ...
    begin
      ...
      Construction.IntValue['Fönsterskikt'] := 5;
      // holder[2] + (holder[2]-1) <- Gasspalter
...
begin
  ...
  // För att välja annan mapp än 'C:\Users\Public\Documents\' se länk
...
begin
  ...
  begin
    ...
    GlazeControlComboBox.Items.Add('Inglasning Ö');
  end
  else
  begin
...
begin
  Form1.Caption := 'Internvärme och Ventilation';
  mainHide;
  IntheatVent;
